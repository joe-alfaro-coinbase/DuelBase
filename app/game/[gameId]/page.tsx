...
export default function GamePage() {
  ...
  const { isPending, isConfirming } = useGameActions();
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-gray-800/50 rounded-2xl p-4 mb-6">
          ...
          {winner && (
            <div className={`rounded-xl p-3 text-center ${
              ...
              <p className={winner.toLowerCase() === address.toLowerCase() ? "text-green-300" : "text-red-300"}>
        ...
        <div className="mt-8 bg-gray-800/30 rounded-xl p-4">
          ...
          <p className="text-sm text-gray-400 mb-2">
            Game state is now synced between players! To test:
          </p>
          <ol className="text-sm text-gray-400 list-decimal list-inside space-y-1">
            ...
            <li>Moves will sync automatically between both players!</li>
          </ol>
        </div>
      </div>
    </div>
